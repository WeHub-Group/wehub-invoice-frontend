...
const Hero = () => {
    ...
    return (
        <div className="bg-heroPattern w-screen p-3 md:h-screen bg-no-repeat bg-cover bg-center" id="hero">
            <div className="flex flex-col h-full justify-center items-start p-5 gap-5">
                <div className="font-extrabold font-lato text-6xl md:text-7xl">Automatic <br></br> Invoice Generator <br></br> For Your Client <br></br> and Business
                </div>
