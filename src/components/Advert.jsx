...
const Advert = () => {
    ...
    return (
        <div className="bg-advertPattern h-[40vh] md:h-[60vh]  bg-center bg-cover flex flex-row p-3 items-center justify-center md:justify-between" id="advert">
            ...
            <img src="/src/assets/advert_card.png" className='hidden md:flex h-[80%] w-[40%]' />
        </div >
    )
}
