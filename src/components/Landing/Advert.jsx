...
const Advert = () => {
    ...
    return (
        <div className="bg-advertPattern h-[40vh] md:h-[60vh]  bg-center bg-cover flex flex-row px-10 md:p-10 items-center justify-center md:justify-between" id="pricing">
